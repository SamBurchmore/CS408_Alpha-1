...
public class AgentFactory {
    ...
    public Agent createAgent(AgentType agentType, Location location) {
        switch (agentType) {
            case PREY:
                return new PreyAgent(location, Color.orange, new PreyReaction(new PreyMotivations()), new BasicVision(), new BasicAttributes(1, 15, 1, 2, AgentType.PREY), new BasicScores(10, 6, 0, 10, 6, 10, 1));
            case PREDATOR:
