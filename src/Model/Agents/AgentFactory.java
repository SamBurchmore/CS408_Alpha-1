...
public class AgentFactory {
    ...
    public Agent createAgent(AgentType agentType, Location location) {
        switch (agentType) {
            case PREY:
                return new PreyAgent(location, Color.blue, new PreyReaction(new PreyMotivations()), new BasicVision(), new BasicAttributes(3, 15, 3, 1, AgentType.PREY), new BasicScores(6, 6, 0, 6, 6, 10, 0));
            case PREDATOR:
