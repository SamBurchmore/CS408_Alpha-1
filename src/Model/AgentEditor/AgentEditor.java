...
//        }
        ...
        activeAgents.addAgent(new BasicAgent(new Location(-1, -1), new PreyReaction(new PreyMotivations()), new BasicVision(), new BasicAttributes("Agent 2", 1, Color.orange, 1, 1, 1, 16, 2, 32, 5, 4, 1), new BasicScores(16, 6, 0, 16, 6, 32, 0)), 1);
        activeAgents.addAgent(new BasicAgent(new Location(-1, -1), new PreyReaction(new PreyMotivations()), new BasicVision(), new BasicAttributes("Agent 3", 2, Color.yellow, 1, 1, 1, 16, 2, 32, 5, 4, 1), new BasicScores(16, 6, 0, 16, 6, 32, 0)), 2);
        activeAgents.addAgent(new BasicAgent(new Location(-1, -1), new PreyReaction(new PreyMotivations()), new BasicVision(), new BasicAttributes("Agent 4", 3, Color.blue, 1, 1, 1, 16, 2, 32, 5, 4, 1), new BasicScores(16, 6, 0, 16, 6, 32, 0)), 3);
        activeAgents.addAgent(new BasicAgent(new Location(-1, -1), new PreyReaction(new PreyMotivations()), new BasicVision(), new BasicAttributes("Agent 5", 4, Color.magenta, 1, 1, 1, 16, 2, 32, 5, 4, 1), new BasicScores(16, 6, 0, 16, 6, 32, 0)), 4);
        activeAgents.addAgent(new BasicAgent(new Location(-1, -1), new PreyReaction(new PreyMotivations()), new BasicVision(), new BasicAttributes("Agent 6", 5, Color.cyan, 1, 1, 1, 16, 2, 32, 5, 4, 1), new BasicScores(16, 6, 0, 16, 6, 32, 0)), 5);
        activeAgents.addAgent(new BasicAgent(new Location(-1, -1), new PreyReaction(new PreyMotivations()), new BasicVision(), new BasicAttributes("Agent 7", 6, Color.pink, 1, 1, 1, 16, 2, 32, 5, 4, 1), new BasicScores(16, 6, 0, 16, 6, 32, 0)), 6);
        activeAgents.addAgent(new BasicAgent(new Location(-1, -1), new PreyReaction(new PreyMotivations()), new BasicVision(), new BasicAttributes("Agent 8", 7, Color.darkGray, 1, 1, 1, 16, 2, 32, 5, 4, 1), new BasicScores(16, 6, 0, 16, 6, 32, 0)), 7);
