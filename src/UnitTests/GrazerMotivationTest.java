...
class GrazerMotivationTest {
    ...
    void runUnoccupied() {
        ...
        System.out.println("1. - Unoccupied, energyLevel>eatAmount: " + desiredScore + "=?" + agentDecision.decisionScore() + " " + agentDecision.agentAction());
        ...
        System.out.println("2. - Unoccupied, energyLevel<eatAmount: " + desiredScore + "=?" + agentDecision.decisionScore() + " " + agentDecision.agentAction());
        assertEquals(agentDecision.decisionScore(), desiredScore);
        assertEquals(agentDecision.agentAction(), AgentAction.GRAZE);
        ...
        desiredScore = 1;
        agentDecision = testAgent.getMotivations().get(0).run(unoccipiedAgentVision, testAgent.getAttributes(), testAgent.getScores());
        System.out.println("3. - Unoccupied, energyLevel==0: " + desiredScore + "=?" + agentDecision.decisionScore() + " " + agentDecision.agentAction());
        assertEquals(agentDecision.decisionScore(), desiredScore);
    ...
    void runOccupiedSmaller() {
        ...
        System.out.println("4. - OccupantSize<TestSubjectSize: " + desiredScore + "=?" + agentDecision.decisionScore() + " " + agentDecision.agentAction());
        assertEquals(agentDecision.decisionScore(), desiredScore);
        assertEquals(agentDecision.agentAction(), AgentAction.GRAZE);
    }
    ...
    void runOccupiedEqual() {
        ...
        System.out.println("5. - OccupantSize==TestSubjectSize: " + desiredScore + "=?" + agentDecision.decisionScore() + " " + agentDecision.agentAction());
        assertEquals(agentDecision.decisionScore(), desiredScore);
    ...
    void runOccupiedLarger() {
        ...
        System.out.println("6. - OccupantSize>TestSubjectSize: " + desiredScore + "=?" + agentDecision.decisionScore() + " " + agentDecision.agentAction());
        assertEquals(agentDecision.decisionScore(), desiredScore);
        assertEquals(agentDecision.agentAction(), AgentAction.NONE);
    }
}