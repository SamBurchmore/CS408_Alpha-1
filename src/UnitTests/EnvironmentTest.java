...
class EnvironmentTest {
    ...
    public void testGetSetTile() {
        ...
        Agent agent0 = new BasicAgent(location0, new BasicAttributes(0, "0", 0, Color.blue, ColorModel.STATIC, 0,1, 3, 4), null);
        Agent agent1 = new BasicAgent(location1, new BasicAttributes(0, "1", 1, Color.blue, ColorModel.STATIC, 0,1, 3, 4), null);
        Agent agent2 = new BasicAgent(location2, new BasicAttributes(0, "2", 2, Color.blue, ColorModel.STATIC, 0,1, 3, 4), null);
        Agent agent3 = new BasicAgent(location3, new BasicAttributes(0, "3", 3, Color.blue, ColorModel.STATIC, 0,1, 3, 4), null);
        ...
        assertTrue(environment.getTile(location0).getOccupant().getAttributes().getID().equals(0));
        assertTrue(environment.getTile(location1).getOccupant().getAttributes().getID().equals(1));
        assertTrue(environment.getTile(location2).getOccupant().getAttributes().getID().equals(2));
        assertTrue(environment.getTile(location3).getOccupant().getAttributes().getID().equals(3));
    }
    ...
    public void testFreeSpace1() {
        ...
        Agent agent2 = new BasicAgent(location2, new BasicAttributes(0, "2", 2, Color.blue, ColorModel.STATIC, 0,1, 3, 4), null);
        Agent agent3 = new BasicAgent(location3, new BasicAttributes(0, "3", 3, Color.blue, ColorModel.STATIC, 0,1, 3, 4), null);
        Agent agent4 = new BasicAgent(location4_center, new BasicAttributes(0, "4", 4, Color.blue, ColorModel.STATIC, 0,1, 3, 4), null);
        Agent agent5 = new BasicAgent(location5, new BasicAttributes(0, "5", 5, Color.blue, ColorModel.STATIC, 0,1, 3, 4), null);
    ...
    public void testGetTileView() {
        ...
        Environment environment = new Environment(2, 2, 6, 2, 1, 5);
        Agent agent0 = new BasicAgent(locationOccupied, new BasicAttributes(0, "0", 0, Color.blue, ColorModel.STATIC, 0,1, 3, 4), null);
        environment.setOccupant(agent0);
    ...
    public void testGetTileColorOccupied() {
        ...
        Agent agent0 = new BasicAgent(location0, new BasicAttributes(0, "0", 0, Color.blue, ColorModel.STATIC, 0,1, 3, 4), null);
        Agent agent1 = new BasicAgent(location1, new BasicAttributes(0, "1", 1, Color.red, ColorModel.STATIC, 0,1, 3, 4), null);
        Agent agent2 = new BasicAgent(location2, new BasicAttributes(0, "2", 2, Color.green, ColorModel.STATIC, 0,1, 3, 4), null);
        Agent agent3 = new BasicAgent(location3, new BasicAttributes(0, "3", 3, Color.yellow, ColorModel.STATIC, 0,1, 3, 4), null);
        environment.setOccupant(agent0);
        environment.setOccupant(agent1);
        environment.setOccupant(agent2);
        environment.setOccupant(agent3);
