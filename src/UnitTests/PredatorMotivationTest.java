...
class PredatorMotivationTest {
    ...
    void runOccupiedSmallerDifferentID() {
        ...
        System.out.println("3. - OccupantSize<TestSubjectSize, OccupantID!=TestSubjectID: " + desiredScore + "=?" + agentDecision.decisionScore() + " " + agentDecision.agentAction());
    ...
    void runOccupiedSmallerSameID() {
        ...
        int desiredScore = -1;
        AgentDecision agentDecision = testAgent.getMotivations().get(0).run(occupiedAgentVision, testAgent.getAttributes(), testAgent.getScores());
        System.out.println("2. - OccupantSize<TestSubjectSize, OccupantID==TestSubjectID: " + desiredScore + "=?" + agentDecision.decisionScore() + " " + agentDecision.agentAction());
        assertEquals(agentDecision.decisionScore(), desiredScore);
    ...
    void runUnoccupied() {
        ...
        int desiredScore = 1;
        AgentDecision agentDecision = testAgent.getMotivations().get(0).run(occupiedAgentVision, testAgent.getAttributes(), testAgent.getScores());
        System.out.println("1. - Unoccupied: " + desiredScore + "=?" + agentDecision.decisionScore() + " " + agentDecision.agentAction());
        assertEquals(agentDecision.decisionScore(), desiredScore);
